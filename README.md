...
| `coverage` | Coverage of departure station<br>[Check your coverage](https://www.navitia.io/datasets) Select a city near your departure station and check the coverage (From now coverage is always sncf)
